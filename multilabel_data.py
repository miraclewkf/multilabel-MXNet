...
def add_data_args(parser):
    ...
    data.add_argument('--image-train', type=str,
                      help='Root folder of train image files')
    data.add_argument('--image-val', type=str,
                      help='Root folder of val image files')
    return data
...
def get_lst_iter(args, kv=None):
    ...
    val = mx.image.ImageIter(
        ...
        data_name           = 'data',
        label_name          = 'softmax_label',
        aug_list            = mx.image.CreateAugmenter((3,224,224),resize=224,mean=True))
    return (train, val)
